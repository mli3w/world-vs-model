...
*as-it-unfolds* strip near the top tracked the biggest forecast moves, which upsets landed, and where
the model and market most disagreed on the matches still to come — round by round, to the final.
